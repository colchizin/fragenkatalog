 ...
 * @var array
 */
	public $fixtures = array('app.group', 'app.user', 'app.comment', 'app.answer', 'app.question', 'app.subject', 'app.programme', 'app.university', 'app.exam', 'app.material', 'app.questions_material', 'app.questions_comment', 'app.answers_comment');
